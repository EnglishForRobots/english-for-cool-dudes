...
'weekly-drop-issue-008': {
  ...
  fix_mistakes: [
    { sentence:'Frasers Group, which already owns a <u>MAJORITY</u> stake of 26% in Hugo Boss, launched a full takeover bid to acquire the rest.', hint:'Is 26% more than half, or less than half?', opts:['majority → CONTROLLING','majority → MINORITY','majority → MINIMUM'], correct:1, fb:'MINORITY — owning 26% is less than half, so it\'s a minority stake, not a majority.' },
    { sentence:'The offer represented a <u>DISCOUNT</u> of 4.3% to Hugo Boss\'s closing price on Wednesday.', hint:'Frasers wanted shareholders to accept — so they offered MORE than the market price.', opts:['discount → REBATE','discount → PRIZE','discount → PREMIUM'], correct:2, fb:'PREMIUM — Frasers offered MORE than the market price to persuade shareholders to sell.' },
    { sentence:'Frasers said the deal was subject to approval from <u>COMPETITORS</u> before it could close.', hint:'Who actually approves big takeover deals — rival companies, or government bodies?', opts:['competitors → REGULATORS','competitors → SHAREHOLDERS','competitors → SHOPPERS'], correct:0, fb:'REGULATORS — government bodies, not rival companies, approve major takeover deals.' },
    { sentence:'The company said it wanted to increase its investment in Hugo Boss to create value for its <u>EMPLOYEES</u>.', hint:'Who actually owns shares in a company — workers, or the people who hold stock?', opts:['employees → UNEMPLOYED','employees → REGULATORS','employees → SHAREHOLDERS'], correct:2, fb:'SHAREHOLDERS — "creating value for shareholders" is the standard phrase; employees are workers, not owners.' },
  ],
...
═══════════════════════════════════════════════════════════════ */
  ...
  true_false: [
   ...
   'weekly-drop-issue-012': {
    ...
    fix_mistakes: [
      { sentence:'"As we get older, the connectivity in our brains often <u>improves</u>, causing memory and speed of thought to decline."', hint:'If memory and speed of thought are declining, is connectivity getting better or worse?', opts:['improves → acquires','improves → deteriorates','improves → accelerates'], correct:1, fb:'DETERIORATES — brain connectivity gets worse with age, not better.' },
      { sentence:'"Higher language <u>deficiency</u> and earlier acquisition of a second language were linked to slower brain ageing."', hint:'Deficiency means lacking something. We want the opposite.', opts:['deficiency → proficiency','deficiency → fluency','deficiency → resilience'], correct:0, fb:'PROFICIENCY — skill in a language, the opposite of "deficiency" (lacking something).' },
      { sentence:'"Multilingual experience matters as a <u>deterioration</u>: depth and duration matter, not simply bilingual or not."', hint:'Which option means a scale of depth/degree?', opts:['deterioration → connectivity','deterioration → threshold','deterioration → gradient'], correct:2, fb:'GRADIENT — a scale of depth and degree, not a decline. Multilingualism matters as a spectrum, not a strict yes/no.' },
      { sentence:'"Researchers could not <u>acquire</u> the possible influence of other factors, such as lifestyle."', hint:'We want something similar to eliminate, exclude, remove...', opts:['acquire → confirm','acquire → rule out','acquire → gradient'], correct:1, fb:'RULE OUT — researchers could not eliminate other possible factors like lifestyle; "acquire" means to obtain, which doesn\'t fit.' },
    ],
